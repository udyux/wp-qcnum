...
<form class="signup<? if ($signupNode['home']) echo ' signup--home'; ?>">
  <h4 class="signup__title"><?= $signupNode['title']; ?></h4>

  <? if (!$signupNode['home']): ?>

    <p class="signup__message"><?= $signupNode['msg']; ?></p>
  ...
  <fieldset>
    ...
    <button id="signup" class="signup__button"><?= $signupNode['home'] ? $signupNode['label'] : 'GO!'; ?></button>
  </fieldset>
</form>
